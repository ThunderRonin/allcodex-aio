...
target: vscode
tools: [vscode, execute, read, agent, edit, search, web, browser, github/create_branch, github/get_commit, github/get_file_contents, github/get_me, github/get_release_by_tag, github/get_tag, github/list_branches, github/list_commits, github/push_files, github/request_copilot_review, github/run_secret_scanning, github/search_code, 'io.github.upstash/context7/*', 'microsoft/markitdown/*', 'sequentialthinking/*', 'stitch/*', 'shadcn/*', vscode.mermaid-chat-features/renderMermaidDiagram, mermaidchart.vscode-mermaid-chart/get_syntax_docs, mermaidchart.vscode-mermaid-chart/mermaid-diagram-validator, mermaidchart.vscode-mermaid-chart/mermaid-diagram-preview, ms-azuretools.vscode-containers/containerToolsConfig, ms-vscode.vscode-websearchforcopilot/websearch, prisma.prisma/prisma-migrate-status, prisma.prisma/prisma-migrate-dev, prisma.prisma/prisma-migrate-reset, prisma.prisma/prisma-studio, prisma.prisma/prisma-platform-login, prisma.prisma/prisma-postgres-create-database, todo]
---
